...
function greeter(hour) {
    ...
    //write conditional that will segment off the morning hours 
 if (hour >= 0 && hour <= 11){
    //print the appropriate morning message
     console.log("Good Morning!");
    //further conditional to segment off afternoon hours
 }  else if (hour >= 12 && hour <= 16) {
    //print the appropriate afternoon message
     console.log("Good Afternoon!");
    //further conditional to segment off evening hours 
 }  else if (hour >= 17 && hour <= 21) {
    //print the appropriate evening message
     console.log("Good Evening!");
    //final conditional statement segmenting off the last hours of the day
 }  else if (hour >= 22 && hour <= 24) {
     //print the good night message 
